...
BaseData = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text= "Курс 1" , callback_data="kbnote1")],
                                                ...
                                                [InlineKeyboardButton(text= "Курс 4 ", callback_data="kbnote4"),InlineKeyboardButton(text= "В главное меню" , callback_data= "in_started")]])
...
bkurs1 = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text= "Лекция 1" , callback_data="k1bnote1")],
                                                ...
                                                [InlineKeyboardButton(text= "Лекция 4 ", callback_data="k1bnote4"),InlineKeyboardButton(text= "В главное меню" , callback_data= "in_started")]])
...
bkurs2 = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text= "Лекция 1" , callback_data="k2bnote1")],
                                                ...
                                                [InlineKeyboardButton(text= "Лекция 4 ", callback_data="k2bnote4"),InlineKeyboardButton(text= "В главное меню" , callback_data= "in_started")]])
...
bkurs3 = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text= "Лекция 1" , callback_data="k3bnote1")],
                                                ...
                                                [InlineKeyboardButton(text= "Лекция 4 ", callback_data="k3bnote4"),InlineKeyboardButton(text= "В главное меню" , callback_data= "in_started")]])
...
bkurs4 = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text= "Лекция 1" , callback_data="k4bnote1")],
                                                ...
                                                [InlineKeyboardButton(text= "Лекция 4 ", callback_data="k4bnote4"),InlineKeyboardButton(text= "В главное меню" , callback_data= "in_started")]])
...
Algoritm = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text= "Курс 1" , callback_data="kanote1")],
                                                ...
                                                [InlineKeyboardButton(text= "Курс 4 ", callback_data="kanote4"),InlineKeyboardButton(text= "В главное меню" , callback_data= "in_started")]])
...
akurs1 = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text= "Лекция 1" , callback_data="k1anote1")],
                                                ...
                                                [InlineKeyboardButton(text= "Лекция 4 ", callback_data="k1anote4"),InlineKeyboardButton(text= "В главное меню" , callback_data= "in_started")]])
...
akurs2 = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text= "Лекция 1" , callback_data="k2anote1")],
                                                ...
                                                [InlineKeyboardButton(text= "Лекция 4 ", callback_data="k2anote4"),InlineKeyboardButton(text= "В главное меню" , callback_data= "in_started")]])
...
akurs3 = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text= "Лекция 1" , callback_data="k3anote1")],
                                                ...
                                                [InlineKeyboardButton(text= "Лекция 4 ", callback_data="k3anote4"),InlineKeyboardButton(text= "В главное меню" , callback_data= "in_started")]])
...
akurs4 = InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text= "Лекция 1" , callback_data="k4anote1")],
                                                ...
                                                [InlineKeyboardButton(text= "Лекция 4 ", callback_data="k4anote4"),InlineKeyboardButton(text= "В главное меню" , callback_data= "in_started")]])
