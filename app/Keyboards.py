...
BaseData = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text="Глава 1", callback_data="kbnote1")],
    [InlineKeyboardButton(text="Глава 2", callback_data="kbnote2")],
    [InlineKeyboardButton(text="Глава 3", callback_data="kbnote3")],
    [InlineKeyboardButton(text="Глава 4", callback_data="kbnote4")]
])

bkurs1 = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text="Лекция 1", callback_data="k1bnote1")],
...
bkurs2 = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text="Лекция 1", callback_data="k2bnote1")],
...
bkurs3 = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text="Лекция 1", callback_data="k3bnote1")],
...
bkurs4 = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text="Лекция 1", callback_data="k4bnote1")],
